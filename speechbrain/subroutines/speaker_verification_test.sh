...
response=$(curl --fail -X POST -F "enrollment_audio=@$BASE_DIR/example.wav" -F "verification_audio=@$BASE_DIR/speaker_verification_true.wav" http://localhost:$port/verify_speaker)
